...
namespace Poliedro.Billing.Api.Controllers.v1.Server
{
    ...
    public class VehiculoTrailerController(IMediator mediator) : ControllerBase
    {
        [HttpGet("{id}")]
        ...
        public async Task<ActionResult<bool>> Create([FromBody] CreateVehiculoTrailerCommand command)
        {
        ...
        [HttpPut("{id}")]
        public void Put(int id, [FromBody] CreateVehiculoTrailerCommand command)
        {
        }
